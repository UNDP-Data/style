...
class SpriteCreator{
    ...
    generateSprite(pxRatio, svgs, output_dir){
        ...
        spritezero.generateLayout({ imgs: svgs, pixelRatio: pxRatio, sdf: this.isSDF, format: true }, function(err, dataLayout) {
            if (err) return;
        ...
        spritezero.generateLayout({ imgs: svgs, pixelRatio: pxRatio, sdf: this.isSDF, format: false }, function(err, imageLayout) {
            if (err) return;
